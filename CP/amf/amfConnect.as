package amf
{
    ...
    public class amfConnect extends Object
    {
        ...
        public function amfConnect(AMFServer:String="https://app.ninjasaga.com/amf_live1/")
        {
            super();
            Server=AMFServer;
        }
		
		public function setServer(s:String)
		{
			Server=s;
		}
		public function getServer(){return Server;}
		
		public function service(arg1:String, arg2:Array, arg3:Function):void{
			this.remotingGateway = Server;
