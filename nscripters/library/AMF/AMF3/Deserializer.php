<?php
     ...
     */
    class NScripters_AMF3_Deserializer extends NScripters_Deserializer {
        ...
        public function readAMFData($settype = null) {
           ...
           switch ($settype) {
                ...
                case NScripters_AMF3_Const::DT_UNDEFINED  : return null;
                case NScripters_AMF3_Const::DT_NULL       : return null;
                case NScripters_AMF3_Const::DT_BOOL_FALSE : return false;
                case NScripters_AMF3_Const::DT_BOOL_TRUE  : return true;
                case NScripters_AMF3_Const::DT_INTEGER    : return $this->readInt();
                case NScripters_AMF3_Const::DT_NUMBER     : return $this->stream->readDouble();
                case NScripters_AMF3_Const::DT_STRING     : return $this->readString();
                case NScripters_AMF3_Const::DT_XML        : return $this->readString();
                case NScripters_AMF3_Const::DT_DATE       : return $this->readDate();
                case NScripters_AMF3_Const::DT_ARRAY      : return $this->readArray();
                case NScripters_AMF3_Const::DT_OBJECT     : return $this->readObject();
                case NScripters_AMF3_Const::DT_XMLSTRING  : return $this->readXMLString();
                case NScripters_AMF3_Const::DT_BYTEARRAY  : return $this->readByteArray();
            ...
            if ($storedObject) {
                ...
                if ($className) {
                    ...
                    if ($localClassName = $this->getLocalClassName($className)) {
                        ...
                        $rObject = new NScripters_TypedObject($className,array());
                ...
                if ($encodingType & NScripters_AMF3_Const::ET_EXTERNALIZED) {

                    if (!$storedClass) {
                        $this->storedClasses[] = array('className' => $className,'encodingType'=>$encodingType,'propertyNames'=>$propertyNames);
                    }
                    if ($rObject instanceof NScripters_Externalized) {
                        $rObject->readExternal($this->readAMFData());
                    } elseif ($rObject instanceof NScripters_TypedObject) {
                    ...
                    if ($encodingType & NScripters_AMF3_Const::ET_SERIAL) {
                    ...
                    if ($rObject instanceof NScripters_TypedObject) {
        ...
        public function readByteArray() {
            ...
            $strlen = $strref >> 1; 
            $str = $this->stream->readBuffer($strlen);
            return new NScripters_ByteArray($str);
