<?php
    ...
    final class NScripters_ClassMapper {

        /**
         * @var array
         */
        static public $maps = array(
            'flex.messaging.messages.RemotingMessage'    => 'NScripters_AMF3_RemotingMessage',
            'flex.messaging.messages.CommandMessage'     => 'NScripters_AMF3_CommandMessage',
            'flex.messaging.messages.AcknowledgeMessage' => 'NScripters_AMF3_AcknowledgeMessage',
            'flex.messaging.messages.ErrorMessage'       => 'NScripters_AMF3_ErrorMessage',
            'flex.messaging.io.ArrayCollection'          => 'NScripters_ArrayCollection'
        );
